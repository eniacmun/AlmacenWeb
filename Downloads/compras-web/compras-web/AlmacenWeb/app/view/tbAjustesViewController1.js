/*
 * File: app/view/tbAjustesViewController1.js
 *
...
Ext.define('almacen.view.tbAjustesViewController1', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.tbmermas',
    ...
    InitializeEnvironment: function(component, eOpts) {
        ...
        Ext.ComponentMgr.get("gridConsultaClasificaciones").columns[4].setText("Cantidad a mermar");;
    ...
    registrarAjustes: function(noImpresiones, motivoAjuste) {
        ...
        var request = {}; request.method="registramermas"; request.params=[];
